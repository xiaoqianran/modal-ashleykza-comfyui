...
This installer clones those upstream GitHub repositories into the Ashley
image using the exact ``nodes.md`` directory names. It does **not**
``COPY --from`` the 23GiB+ CNB runtime image (CUDA 13 / models / venv).
