...
| `COMFY_IMAGE` | `ghcr.io/ashleykleynhans/comfyui:cu128-py312-v0.32.0` | 基础镜像。GPU Image 额外 apt：`cmake` `ninja-build` `build-essential` `python3-dev`（CNR 编译 natten / CUDA 扩展） |
