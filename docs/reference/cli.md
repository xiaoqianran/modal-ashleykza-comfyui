...
本机 `127.0.0.1:8787`，启动后默认打开浏览器。顶栏选 Z-Image / Z-Image-Turbo / FLUX.2 [dev] / Qwen-Image-2512 / Qwen-Image-2512 Lightning / Krea-2 Turbo / Ideogram 4 / Pixal3D / TripoSplat。见 [Studio](../guide/studio.md)。
