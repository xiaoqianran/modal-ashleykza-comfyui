...
# These are deliberately only the nodes absent from the pinned 130-node base.
...
PROFILES: Mapping[str, Profile] = {
    "base": Profile(description="Ashley runtime + pinned 130-node CNB base snapshot; no recipe models."),
